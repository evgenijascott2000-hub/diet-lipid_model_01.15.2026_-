...
**最强效应 (Top 5 Beta)**:
- Intercept → total_cholesterol_mmol_L: β=5.806, p=0.00e+00
- Intercept → total_cholesterol_mmol_L: β=5.806, p=0.00e+00
- Intercept → total_cholesterol_mmol_L: β=5.806, p=0.00e+00
- Intercept → ldl_cholesterol_mmol_L: β=3.645, p=0.00e+00
- Intercept → ldl_cholesterol_mmol_L: β=3.645, p=0.00e+00
...
**筛选频率最高的饮食变量 (Top 5)**:
- diet_salad_raw_vegetable_intake_daily: 在6个脂质模型中被选中
- diet_coffee_intake_daily: 在6个脂质模型中被选中
- diet_fresh_fruit_intake_daily: 在6个脂质模型中被选中
- diet_oily_fish_intake_daily: 在6个脂质模型中被选中
- diet_non_oily_fish_intake_daily: 在6个脂质模型中被选中
...
Total features (diet variables): 17
Sample size: 72811

Component Selection Criteria:
  95% variance threshold: 16 components
  80% variance threshold: 13 components
  Kaiser criterion (eigenvalue > 1): 6 components
  Elbow method suggestion: 3 components
